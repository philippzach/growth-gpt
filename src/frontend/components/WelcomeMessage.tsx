    ...
    <div className="max-w-2xl mx-auto text-center py-12">
      ...
      <div className="mb-8">
        ...
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">
          Welcome to Your Growth Strategy Session
        </h1>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg p-6 mb-8 shadow-sm border border-gray-200 dark:border-gray-700">
        ...
        <div className="grid md:grid-cols-3 gap-4 text-left">
          <div className="flex items-start space-x-3">
            ...
            <div>
              <h3 className="font-medium text-gray-900 dark:text-white mb-1">Share Your Idea</h3>
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              <h3 className="font-medium text-gray-900 dark:text-white mb-1">Review & Refine</h3>
              <p className="text-sm text-gray-600 dark:text-gray-300">
      ...
      <div className="mt-8 text-xs text-gray-500 dark:text-gray-400">
        <p>
          💡 <strong>Tip:</strong> Be as specific as possible about your business idea, target market, and goals for the best results.
        </p>
      </div>
    </div>
  );
